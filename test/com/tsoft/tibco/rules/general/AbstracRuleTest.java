...
public class AbstracRuleTest {
	...
	/**
	 * Metodo que prepara un contexto e invoca una ejecución de una regla sobre
	 * un código. El contexto se informa con las violaciones encontradas por la
	 * regla y una ruta relativa del archivo al que corresponde el còdigo
	 * analizado.
	 * 
	 * @param rule
	 * @param code
	 ...
	 * Metodo que prepara un contexto e invoca una ejecución de una regla sobre
	 * un código. El contexto se informa con las violaciones encontradas por la
	 * regla, además de la ruta a una carpeta raiz simulada sobre la que se está
	 * ejecutando el análisis, y una ruta relativa del archivo al que
	 * corresponde el còdigo analizado.
	 * 
	 * @param rule
	 *            - regla validada
	 * @param code
